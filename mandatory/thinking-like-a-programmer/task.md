...
A programmer should understand the problem and solve it.

## 2. When trying to solve a challenge, what should you do first?

First should break the challenge in chuncks, to find a solution.

## 3. What should you do if you get stuck?

first come back to the problem and try to really understand, after break it in more chuncks and debug it as much as possible.
