...
Think like a programmer, ability to break down complex problems into smaller chunks in a systematic way.

## 2. When trying to solve a challenge, what should you do first?

<!-- Write your answer here -->

Understand the problem, plan and breakdown problem into smaller steps.

## 3. What should you do if you get stuck?

<!-- Write your answer here -->

- Explain what you’re trying to do to a rubber ducky to help understand the problem
- Know the computer is doing exactly what you wrote not what you want
- Research if needed
- If all else fails start over
  Work on algorithms or sudoku puzzles to help you practice problem-solving
